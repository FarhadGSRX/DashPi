...
int main(int argc, char *argv[]) {
  ...
  /*
   * Set up the AdaRGBMatrix. It implements a 'Canvas' interface.
   */
  AdaRGBMatrix *canvas = new AdaRGBMatrix(&io, rows, chain);
  ...
  while (fgets(line, sizeof(line), stdin)) {
    ...
    if (line_empty)
      continue;
    adargb_matrix::DrawText(canvas, font, x, y + font.baseline(), color, line);
    y += font.height();
  }
