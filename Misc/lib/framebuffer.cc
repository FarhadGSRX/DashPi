...
AdaRGBMatrix::Framebuffer::Framebuffer(int rows, int columns)
...
AdaRGBMatrix::Framebuffer::~Framebuffer() {
  delete [] bitplane_buffer_;
}

/* statuc */ void AdaRGBMatrix::Framebuffer::InitGPIO(GPIO *io) {
...
bool AdaRGBMatrix::Framebuffer::SetPWMBits(uint8_t value) {
...
inline AdaRGBMatrix::Framebuffer::IoBits *
AdaRGBMatrix::Framebuffer::ValueAt(int double_row, int column, int bit) {
...
inline uint16_t AdaRGBMatrix::Framebuffer::MapColor(uint8_t c) {
...
void AdaRGBMatrix::Framebuffer::Clear() {
#ifdef INVERSE_RGB_DISPLAY_COLORS
  Fill(0, 0, 0);
#else
...
void AdaRGBMatrix::Framebuffer::Fill(uint8_t r, uint8_t g, uint8_t b) {
...
void AdaRGBMatrix::Framebuffer::SetPixel(int x, int y,
...
void AdaRGBMatrix::Framebuffer::DumpToMatrix(GPIO *io) {
